...
@include('inc.modal');
    ...
    <form action="{{ route('invoices.store')}}" method="post" id="add-stock-form" target="_blank">
            ...
            @csrf
                ...
                <div class="w-50 text-center m-auto entree_page">
                    <label for="fournisseurs" class="mt-2">  <h4>Selectionner Fournisseur </h4> </label>
    ...
    <table class="medicamentstable table hover text-dark mt-5 text-center m-auto">
        ...
        <tr>
            ...
            <th scope="col" style="width: 16%">N.prix</th>
            <th scope="col">Quantite</th>
            <th scope="col" class="dpass">pourcentage </th>
        ...
        $(document).ready(function () {
            fournisseurSelect.on('change',function () {
                ...
                $('.medicamentstable').DataTable({
                   ...
                   "bDestroy": true,
                    "pageLength": 5,
                    "aoColumnDefs": [ { "sClass": "dpass", "aTargets": [0,5] } ]
