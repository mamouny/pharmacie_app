...
<div class="container">
    <div class="row m-5 justify-content-around">
        <div class="col-8">
            <h2> Pharmacie </h2> <br>
            <div class="mb-2">
                <h5 class="font-italic d-inline"> Date : </h5> <span class="font-weight-bold">{{ $dateF}}</span>
            </div>
            <div>
                <h5 class="font-italic d-inline">   Fournisseur : </h5>
                <span class="nom-fournisseur font-weight-bold">{{ $fourn_nom}}</span>
            </div>

        </div>
        <div class="col-4">
            <h5 class="d-inline font-weight-bolder">Facture N : </h5> <span class=""> {{ $numFacture}}</span>
        </div>
    </div>
